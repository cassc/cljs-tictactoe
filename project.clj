(defproject fcc-tictactoe "0.1.0-SNAPSHOT"
  :description "An freecodecamp project: tictactoe"
  :url "https://github.com/cassc/cljs-tictactoe"
  ...
  :profiles {:prod {:hooks [leiningen.cljsbuild]
                    :cljsbuild {:builds {:app
                                         {:figwheel false
                                          ...
                                          {:output-to "resources/public/cljs/tictactoe.js"
                                           :output-dir "resources/public/cljs/prod"
                                           :optimizations :advanced ;; :whitespace :advanced
                                           :source-map "resources/public/cljs/tictactoe.map"
